...
- (void)record:(CDVInvokedUrlCommand*)command {
    ...
    // Ning Wei 20180608
    // Load qlevel from args
    NSNumber *qlevel = [_command.arguments objectAtIndex:1];
    // END
    ...
    [self.commandDelegate runInBackground:^{
        ...
        // Ning Wei 20180608
        // Adapt different options for qlevel
        // 100 stands for QUALITY_LEVEL_LOW
        if(qlevel == [NSNumber numberWithInt:100]){
            [recordSettings setObject:[NSNumber numberWithInt: kAudioFormatMPEG4AAC] forKey: AVFormatIDKey];
            [recordSettings setObject:[NSNumber numberWithFloat:44100.0] forKey: AVSampleRateKey];
            [recordSettings setObject:[NSNumber numberWithInt:1] forKey:AVNumberOfChannelsKey];
            [recordSettings setObject:[NSNumber numberWithInt:16000] forKey:AVEncoderBitRateKey];
